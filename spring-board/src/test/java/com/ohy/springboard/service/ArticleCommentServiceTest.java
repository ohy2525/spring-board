...
class ArticleCommentServiceTest {
    ...
    @Test
    void failLogsSituationAndDoesNothing() {
        // Given
        ArticleCommentDto dto = createArticleCommentDto("댓글");
    ...
    @Test
    void failUpdateLogsWarningAndDoesNothing() {
        // Given
        ArticleCommentDto dto = createArticleCommentDto("댓글");
