...
class ArticleControllerTest {
    ...
    @WithUserDetails(value = "ohyTest", userDetailsServiceBeanName = "userDetailsService", setupBefore = TestExecutionEvent.TEST_EXECUTION)
    ...
    @Test
    void updateRedirectsToLoginPage() throws Exception {
        //given
        long articleId = 1L;
