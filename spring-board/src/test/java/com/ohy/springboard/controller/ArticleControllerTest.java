...
class ArticleControllerTest {
    ...
    @Test
    public void ArticlesListViewTest() throws Exception {
        //given
    ...
    @Test
    public void ArticleDetailViewTest() throws Exception {
        // Given
    ...
    @Test
    public void ArticleSearchViewTest() throws Exception {
        //given
    ...
    @Test
    public void noHashtagSearchViewTest() throws Exception {
        //given
    ...
    @Test
    public void HashtagSearchViewTest() throws Exception {
        //given
        String hashtag = "#java";
        given(articleService.searchArticlesViaHashtag(eq(hashtag), any(Pageable.class))).willReturn(Page.empty());
        given(articleService.getHashtags()).willReturn(List.of("#java", "#spring"));
        given(paginationService.getPaginationBarNumbers(anyInt(), anyInt())).willReturn(List.of(1, 2, 3, 4, 5));
